...
import { ORDER_BILLS_SHEET_HEADERS } from "./const";

export class OrderBillsSheet extends BaseGoogleSheet implements IGoogleRowsSheet {
  async readRows(
    range = `A:${lastColumnLetter(ORDER_BILLS_SHEET_HEADERS.length - 1)}`,
