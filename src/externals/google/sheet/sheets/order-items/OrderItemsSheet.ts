...
import { ORDER_ITEMS_SHEET_HEADERS } from "./const";

export class OrderItemsSheet extends BaseGoogleSheet implements IGoogleRowsSheet {
  async readRows(
    range = `A:${lastColumnLetter(ORDER_ITEMS_SHEET_HEADERS.length - 1)}`,
